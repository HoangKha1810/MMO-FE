  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#06090f] px-4 text-white">
      <form onSubmit={submit} className="w-full max-w-md rounded-[2rem] border border-white/10 bg-white/[0.04] p-7 shadow-2xl">
        ...
        <p className="mt-2 text-sm font-semibold text-slate-400">Cổng đăng nhập riêng cho tài khoản role admin.</p>
        ...
        <div className="mt-6 space-y-4">
          <Input placeholder="Admin username/email" value={form.username} onChange={(e) => setForm({ ...form, username: e.target.value })} required />
