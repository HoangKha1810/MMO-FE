...
const SECTION_TITLE_LABELS: Record<string, string> = {
  ...
  'Game market items': 'Bài trao đổi game',
  'Game market orders': 'Đơn trao đổi game',
...
const COLUMN_LABELS: Record<string, string> = {
  ...
  post_id: 'Post ID',
  item_id: 'Vật phẩm ID',
  seller_id: 'Người đăng',
  buyer_id: 'Người tạo đơn',
  created_at: 'Tạo lúc',
  ...
  cost_source: 'Nguồn giá vốn',
  cost_hourly_usd: 'Giá vốn USD/giờ',
  cost_hourly_vnd: 'Giá vốn VNĐ/giờ',
  sale_hourly_vnd: 'Giá bán VNĐ/giờ',
  profit_hourly_vnd: 'Chênh lệch/giờ',
