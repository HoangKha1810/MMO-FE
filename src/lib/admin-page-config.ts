...
export const adminPageSections: Record<string, AdminSectionConfig[]> = {
  users: [
    {
      ...
      columns: ['id', 'username', 'email', 'fullname', 'role', 'status', 'balance', 'game_balance', 'rank', 'is_blue_tick', 'blue_tick_expiry', 'last_ip', 'created_at'],
      editableFields: ['fullname', 'email', 'role', 'status', 'balance', 'game_balance', 'rank', 'fa_enabled', 'telegram_2fa_enabled', 'fa_type', 'lock_reason', 'locked_until', 'is_blue_tick', 'blue_tick_expiry'],
  ...
  'blue-tick': [
    {
      resource: 'blue-tick-orders',
      title: 'Đơn tick xanh',
      description: 'Quản lý đơn mua/gia hạn tick xanh 1 tháng 49.000đ. Admin có thể chỉnh trạng thái, ghi chú và hạn dùng khi cần.',
      columns: ['id', 'order_code', 'user_id', 'username', 'email', 'price_vnd', 'months', 'balance_after', 'start_at', 'expires_at', 'status', 'admin_note', 'created_at'],
      editableFields: ['status', 'admin_note', 'price_vnd', 'months', 'start_at', 'expires_at'],
      statusOptions: ['completed', 'pending', 'processing', 'canceled', 'refunded'],
  ...
  'vibe-code': [
    {
      ...
      description: 'Đồng bộ sản phẩm từ GenZ Shop. Auto price mặc định cộng margin 80%, nếu admin nhập giá bán tay thì giữ nguyên giá web.',
      columns: ['id', 'vendor_product_id', 'provider', 'title', 'stock_available', 'source_price_vnd', 'sale_price_vnd', 'margin_percent', 'is_auto_price', 'status', 'synced_at'],
      editableFields: ['title', 'description', 'unit_label', 'unit_amount', 'source_price_vnd', 'sale_price_vnd', 'margin_percent', 'is_auto_price', 'stock_available', 'display_order', 'status'],
      ...
      statusOptions: ['active', 'inactive', 'unavailable'],
      actions: [{ key: 'sync-vibe-code', label: 'Đồng bộ GenZ' }],
    },
    {
      resource: 'vibe-code-orders',
      title: 'Đơn Vibe Code',
      description: 'Đơn khách đã mua qua GenZ, credential giao về, giá API đã trừ và lợi nhuận.',
      columns: ['id', 'order_code', 'username', 'vendor_order_code', 'provider', 'package_title', 'source_price_vnd', 'sale_price_vnd', 'provider_amount_vnd', 'profit_vnd', 'status', 'credentials', 'admin_note', 'created_at'],
      editableFields: ['status', 'admin_note', 'sale_price_vnd', 'source_price_vnd', 'provider_amount_vnd', 'profit_vnd', 'credentials', 'failure_reason'],
      statusOptions: ['pending', 'processing', 'completed', 'failed', 'canceled', 'refunded'],
      actions: [ORDER_BULK_DELETE_ACTION],
    },
  ],
  'kenh-tiktok': [
    ...
    },
    {
      ...
      description: 'Sản phẩm đồng bộ từ Kênh Giá Rẻ. Hệ thống tự refresh khi dữ liệu quá 24h; nút Refresh kéo kênh mới, giá API mới, shopStatus, liveStatus và tự tính giá bán web theo margin cho các kênh đang bật auto price. Nếu nhập giá tay, hệ thống chỉ cộng VAT 8% khi bán.',
  ...
  orders: [
    ...
    },
    {
      resource: 'vibe-code-orders',
      title: 'Đơn Vibe Code',
      description: 'Đơn Vibe Code qua GenZ và trạng thái cấp gói.',
      columns: ['id', 'order_code', 'username', 'vendor_order_code', 'provider', 'package_title', 'source_price_vnd', 'sale_price_vnd', 'provider_amount_vnd', 'profit_vnd', 'status', 'credentials', 'admin_note', 'created_at'],
      editableFields: ['status', 'admin_note', 'sale_price_vnd', 'source_price_vnd', 'provider_amount_vnd', 'profit_vnd', 'credentials', 'failure_reason'],
      statusOptions: ['pending', 'processing', 'completed', 'failed', 'canceled', 'refunded'],
      actions: [ORDER_BULK_DELETE_ACTION],
